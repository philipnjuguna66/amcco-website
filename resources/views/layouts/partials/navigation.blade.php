...
<div class="bg-teal-600 text-white mt-0 pt-0 sticky top-0 left-0 right-0 z-50" x-data="{ open: false }">
           ...
           <div class="hidden md:flex ">
                <div class="text-white">
                    <div class="flex flex-row gap-4">
                        ...
                        <a href="https://www.facebook.com/amccopropertiesltd" target="_blank">Facebook</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-4">
                        ...
                        <a href="https://twitter.com/amccoproperties" target="_blank">Twitter</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-4">
                        ...
                        <a href="https://www.instagram.com/amccoproperties/" target="_blank">Instagram</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-4">
                        ...
                        <a href="https://www.youtube.com/@amccopropertiesltd" target="_blank">Youtube</a>
                    </div>
