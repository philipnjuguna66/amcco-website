        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 space-y-4 mt-4 py-4">
            ...
            <div>
                ...
                @foreach($section->extra['sections'] as $index => $content)
                    <div class="prose shadow-md rounded-md px-4 mt-5  py-8 border-b-4 border-primary-600 border-b-primary-600">
                ...
                @if(isset($section->extra['has_contact_form']) && $section->extra['has_contact_form'])
                    <div class="shadow-md rounded-md px-4 mt-5  py-8 border-b-4 border-primary-600 border-b-primary-600">
